...
Vue.component('gtp', {
    ...
    <input class = "inputField" id = "userAnswer" placeholder = "Type your answer here." v-model = "userAnswer">
    <input class="button" type="submit" value="Check Answer"> 
    </form>

    <h2 class = "title" v-if = "isRevealedFunc()">The answer was: <span style = "color:red;">{{answer}}</span></h2> <br>

    <button class = "button" @click="nextPokemon()">Next Pokemon</button>
    ...
    methods: {
        ...
        async loadPokemon() {
            ...
            // return the answer in console for debugging
